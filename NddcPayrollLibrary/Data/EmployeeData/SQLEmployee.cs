...
namespace NddcPayrollLibrary.Data.EmployeeData
{
    public class SQLEmployee : IEmployeeData
    {
        ...
        public MyPaySlipModel GetEmployeePaySlip(int empId, int payrollJournalId)
        {
            ...
            string SQL = "SELECT PayrollJournals.Id, PayrollJournals.FirstName, PayrollJournals.LastName, PayrollJournals.EmployeeCode, PayrollJournals.PayPoint, JobTitles.Description, PayrollJournals.DateEngaged, PayrollJournals.AccountNumber, PayrollJournals.BankCode, PayrollJournals.TransportAllow, PayrollJournals.HousingAllow, PayrollJournals.FurnitureAllow, PayrollJournals.MealAllow, PayrollJournals.UtilityAllow, PayrollJournals.MedicalAllow, PayrollJournals.EducationAllow, PayrollJournals.SecurityAllow, PayrollJournals.DomesticServantAllow, PayrollJournals.DriverAllow, PayrollJournals.VehicleAllow As VehicleMaintenanceAllow, PayrollJournals.HazardAllow, PayrollJournals.Tax, PayrollJournals.NHF, PayrollJournals.JSA, PayrollJournals.CooperativeDed, PayrollJournals.SSA, PayrollJournals.TotalEarnings, PayrollJournals.TotalDeductions, PayrollJournals.NetPay, PayrollJournals.BasicSalary, PayrollJournals.Pension, PayrollJournals.MonthYear As DateOfPayment, PayrollJournals.DepartmentName, PayrollJournals.GradeLevel As JobGrade, PayrollJournals.EmployeeId, JobTitles.Description As JobTitle FROM  PayrollJournals LEFT OUTER JOIN JobTitles ON PayrollJournals.JobTitleId = JobTitles.Id WHERE PayrollJournals.EmployeeId = @empId AND PayrollJournals.PayrollJournalTitleId = @payrollJournalId";
