...
{
    public class EmployeeAdhocModel : PageModel
    {
        ...
        [BindProperty(SupportsGet = true)]
        public List<MyPayRollListModel> Employees { get; set; }

        public EmployeeAdhocModel(ICompanyData compDb, IReportsData repDb)
        {
            this.compDb = compDb;
            this.repDb = repDb;
        }
        ...
        public void OnPost()
        {
            ...
            Employees = repDb.GetEmployeeAdhocAsync(GradeLevel.Id, Category, Department.Id, Gender);

           

        }

        public IActionResult OnPostExcelExport()
        {
            GradeLevels = compDb.GetAllGradeLevels();
            Departments = compDb.GetAllDepartments();
            ...
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                worksheet.Range["B1"].Text = "Employee Adhoc Report";
                ...
                worksheet.Range["B2"].Text = "005-NIGER DELTA DEVELOPMENT COMMISSION";
                ...
                worksheet.Range["B3"].Text = $"Current Period: {DateTime.Now.ToShortDateString()}";
                ...
                worksheet.Range["B4"].Text = $"Printed on: {DateTime.Now.ToString()} for Current Period {DateTime.Now.ToShortDateString()}";
                ...
                worksheet.ImportData(Employees, 6, 1, true);
                worksheet.Range["A6:AJ6"].AutofitColumns();
                worksheet.Range["A6:AJ6"].CellStyle.Font.Bold = true;
                worksheet.Range["A6:AJ6"].CellStyle.Font.Size = 11;

                int mCount = Employees.Count();
                ...
                ////Enter text to the cell B3 and apply formatting.
                //worksheet2.Range["B3"].Text = $"Current Period: {DateTime.Now.ToShortDateString()}";
                ...
                ////Enter text to the cell B4 and apply formatting.
                //worksheet2.Range["B4"].Text = $"Printed on: {DateTime.Now.ToString()} for Current Period {DateTime.Now.ToShortDateString()}";
                ...
                fileStreamResult.FileDownloadName = $"EmployeeAdhoc-{DateTime.Now.ToString()}.xlsx";
