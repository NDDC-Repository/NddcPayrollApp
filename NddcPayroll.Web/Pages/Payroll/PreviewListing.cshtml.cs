...
{
    public class PreviewListingModel : PageModel
    {
        ...
        public PreviewListingModel(IReportsData repDb)
        {
            this.repDb = repDb;
        }
        public void OnGet()
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                worksheet.Range["B3"].Text = $"Current Period: {currPeriod}";
                ...
                worksheet.Range["B4"].Text = $"Printed on: {DateTime.Now.ToString()} for Current Period {currPeriod}";
                ...
                //Enter text to the cell B3 and apply formatting.
                worksheet2.Range["B3"].Text = $"Current Period: {currPeriod}";
                ...
                //Enter text to the cell B4 and apply formatting.
                worksheet2.Range["B4"].Text = $"Printed on: {DateTime.Now.ToString()} for Current Period {currPeriod}";
